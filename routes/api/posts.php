...
Route::get('/projects', [ProjectController::class, 'index']);            // List all projects (GET)
Route::get('/projects/{id}', [ProjectController::class, 'show']);        // Get a specific project (GET)
Route::post('/projects', [ProjectController::class, 'store']);           // Create a new project (POST)
Route::put('/projects/{id}', [ProjectController::class, 'update']);      // Update a specific project (PUT)
Route::delete('/projects/{id}', [ProjectController::class, 'destroy']);  // Delete a specific project (DELETE)
